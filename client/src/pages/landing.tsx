...
export default function Landing() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#090B1A] via-[#141B2D] to-[#090B1A]">
      ...
      {/* FAQ Section */}
      <section id="faq" className="py-20 sm:py-32 bg-white/[0.02]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <Accordion type="single" collapsible className="space-y-4">
            <AccordionItem value="item-1" className="bg-white/[0.02] border border-white/10 rounded-xl px-6">
            ...
            <AccordionItem value="item-2" className="bg-white/[0.02] border border-white/10 rounded-xl px-6">
            ...
            <AccordionItem value="item-3" className="bg-white/[0.02] border border-white/10 rounded-xl px-6">
            ...
            <AccordionItem value="item-4" className="bg-white/[0.02] border border-white/10 rounded-xl px-6">
            ...
            <AccordionItem value="item-5" className="bg-white/[0.02] border border-white/10 rounded-xl px-6">
            ...
            <AccordionItem value="item-6" className="bg-white/[0.02] border border-white/10 rounded-xl px-6">
            ...
            <AccordionItem value="item-7" className="bg-white/[0.02] border border-white/10 rounded-xl px-6">
            ...
            <AccordionItem value="item-8" className="bg-white/[0.02] border border-white/10 rounded-xl px-6">
